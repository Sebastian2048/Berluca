...
def generar_maestro_m3u():
    ...
    fusionando toda la metadata para clientes sensibles (Movian).
    """
    ...
    try:
        with open(ruta_final, "w", encoding="utf-8") as salida:
            ...
            for i in range(1, MAX_SERVIDORES_BUSCAR + 100): 
                ...
                # 📌 FORMATO SOLICITADO (Fusión de metadata en #EXTALB)
                # Eliminamos #EXTINF por completo.
                # La estructura será: #EXTALB:Metadata \n URL
        ...
        print(f"   -> ¡Importante! Este es el formato #EXTALB final. Prueba en Movian.")
